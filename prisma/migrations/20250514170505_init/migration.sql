-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CUSTOMER', 'MECHANIC', 'SELLER', 'ADMIN');

-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('PART', 'VEHICLE', 'SERVICE');
...
CREATE TABLE "Product" (
    ...
    "sellerId" TEXT,
    "type" "ProductType" NOT NULL DEFAULT 'PART',
    "condition" TEXT,
    "make" TEXT,
    "model" TEXT,
    "year" TEXT,
...
-- AddForeignKey
ALTER TABLE "ServiceBooking" ADD CONSTRAINT "ServiceBooking_mechanicId_fkey" FOREIGN KEY ("mechanicId") REFERENCES "Mechanic"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
