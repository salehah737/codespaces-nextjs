...
import MechanicRegistrationForm from '../../components/registration/MechanicRegistrationForm';
...
export default function MechanicRegistrationPage() {
  ...
  const nextStep = () => {
    track('mechanic_registration_step', { step: step + 1 });
    setStep(prev => prev + 1);
    window.scrollTo(0, 0);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    track('mechanic_registration_complete', { 
      ...
      <div className="container mx-auto px-4">
        <ScrollReveal>
          <h1 className="text-3xl font-bold text-center mb-2">
            {language === 'ms' ? 'Pendaftaran Mekanik' : 'Mechanic Registration'}
          </h1>
          <p className="text-gray-600 text-center mb-8">
            {language === 'ms' 
              ? 'Sertai rangkaian mekanik kami dan dapatkan pelanggan baharu' 
              : 'Join our network of mechanics and get new customers'}
          </p>
        </ScrollReveal>
              ...
              {[1, 2, 3].map((i) => (
                ...
                >
                  ...
                  <div className="text-xs text-center mt-2">
                    {language === 'ms' 
                      ? ['Maklumat Peribadi', 'Maklumat Profesional', 'Pengesahan'][i-1]
                      : ['Personal Info', 'Professional Info', 'Verification'][i-1]
                    }
                  </div>
                </div>
              ))}
            ...
            {step === 4 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 mb-6">
                  {language === 'ms' 
                    ? 'Terima kasih kerana mendaftar sebagai mekanik di MatMoto-PomenPro. Kami akan menghubungi anda untuk pengesahan dalam masa 24-48 jam.'
                    : 'Thank you for registering as a mechanic with MatMoto-PomenPro. We will contact you for verification within 24-48 hours.'
                  }
                </p>
                <CTAButton
                  href="/dashboard"
